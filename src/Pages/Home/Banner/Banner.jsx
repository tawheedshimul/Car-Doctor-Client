    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl h-full flex itmes-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 21)]">
                    <div className='text-white space-y-7 w-1/2 pl-12 pt-20'>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl h-full flex itmes-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 21)]">
                    <div className='text-white space-y-7 w-1/2 pl-12 pt-20'>
                        ...
                        <div>
                            <button className="bg-orange-500 mr-5 hover:bg-orange-700 text-white font-bold py-2 px-4 border border-orange-700 rounded">
                                Discover More
                            </button>
                            <button className="bg-transparent hover:bg-orange-500 text-orange-500 font-semibold hover:text-white py-2 px-4 border border-orange-500 hover:border-transparent rounded">
                                Latest Product
